...
const Card = ({ gap, py = 'sm', px = 'sm', children }) => {
  return (
    <div className='relative overflow-auto border-2 border-amber-600 bg-black bg-opacity-80 p-2 before:absolute before:top-2 before:left-2 before:h-3 before:w-3 before:border-2 before:border-amber-600 after:absolute after:right-2 after:top-2 after:h-3 after:w-3 after:border-2 after:border-amber-600'>
      <div
        className={clsx(
